...
download.addEventListener('click', function () {
    ...
    // link.click();
    // document.documentElement.style.setProperty(`--blur`, inputs[0].value + 'px')
    // document.documentElement.style.setProperty(`--invert`, inputs[1].value + '%')
    // document.documentElement.style.setProperty(`--sepia`, inputs[2].value + '%')
    // document.documentElement.style.setProperty(`--saturate`, inputs[3].value + '%')
    // document.documentElement.style.setProperty(`--hue`, inputs[4].value + 'deg')
    // download.value = ''
    const image = new Image()
    image.setAttribute('crossOrigin', 'anonymous')
    image.src = srcImage
